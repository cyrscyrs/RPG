...
public class Blackhole_Skill_Controller : MonoBehaviour
{
    ...
    {
        if (cloneAttackTimer < 0 && cloneCanAttack && amountOfAttacks > 0)
        {
    ...
    private void CreateHotKey(Collider2D collision)
    {
        ...
        newHotKeyScrip.SetupHotKey(choosenKey, collision.transform, this);
    }

    public void AddTargetToList(Transform _target) => targets.Add(_target);
